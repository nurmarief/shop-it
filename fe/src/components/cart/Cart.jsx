...
const Cart = () => {
  ...
  return (
    <>
      ...
      {
        cartItems.length === 0 ?
          <h2 className="mt-5">Your Cart <b>is Empty</b></h2>
          :
          <>
            ...
            <div className="row d-flex justify-content-between">
              ...
              <div className="col-12 col-lg-3 my-4">
                <div id="order_summary">
                  <h4>Order Summary</h4>
                  <hr />
                  <p>Total Units: <span className="order-summary-values">{cartItems?.reduce((acc, item) => acc + item?.quantity, 0)} (Units)</span></p>
