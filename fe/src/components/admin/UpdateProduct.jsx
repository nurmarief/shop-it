...
import { useUpdateProductMutation, useGetProductDetailsQuery } from '../../redux/api/products';
        ...
        <div className="row wrapper">
          <div className="col-10 col-lg-10 mt-5 mt-lg-0">
            <form className="shadow rounded bg-body" onSubmit={submitHandler}>
              ...
              <button type="submit" className="btn w-100 py-2" disabled={isLoading}>CREATE</button>
            </form>
          </div>
        </div>
      </Admin>
